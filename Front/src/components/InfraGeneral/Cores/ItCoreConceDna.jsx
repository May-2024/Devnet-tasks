...
export function ItCoreConceDna({
  devicesInterfaces,
  devicesHealth,
  neighbors,
  routeStatus,
  ...
  const routeDefault = routeStatus.filter((e) => {
    return e.name === "CONCE-DNA" && e.via_bgp === "true";
  });
    ...
    <>
      <div className="table-infra-general-container">
        <table className="table-core">
          <thead>
            <tr>
              <th>CORE-CONCE-DNA 10.224.127.161</th>
              <th>STATUS</th>
            </tr>
          </thead>
          <tbody>
