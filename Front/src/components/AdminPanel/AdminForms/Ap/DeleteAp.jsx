...
export const DeleteAp = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.delete(
        `${BASE_API_URL}/infra_general/ap/remove/${ip}`,
        {
          headers: {
  ...
  return (
      ...
      <div className="form-container">
        <h2 className="form-title">Eliminar AP</h2>
        <form onSubmit={handleSubmit}>
          <div>
            <label className="form-label" htmlFor="ip">Ip del AP a eliminar:</label>
            <input
